...
-- When the character is revived from human基础移速
local function onbecamehuman(inst)
	-- Set speed when not a ghost (optional)
	inst.components.locomotor:SetExternalSpeedMultiplier(inst, "esctemplate_speed_mod", 1.05)
end
...
local master_postinit = function(inst)
	...
	-- Damage multiplier (optional)伤害速率
    inst.components.combat.damagemultiplier = 1.1
	
	-- Hunger rate (optional)饥饿速率
